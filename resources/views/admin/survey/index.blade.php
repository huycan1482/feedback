            ...
            <div class="box">
                ...
                <div class="box-body">
                        ...
                        <tbody>
                            ...
                            <tr class="item-{{ $feedback->id }}">
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="{{ route('admin.survey.edit', ['id'=> $feedback->id]) }}" class="btn btn-success" title="Sửa">
                                        <i class="fa fa-edit"></i>
                                    </a>

                                    <a href="javascript:void(0)" class="btn btn-danger" onclick="destroyModel('survey', '{{ $feedback->id }}' )" title="Xóa">
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            @foreach($feedbacksWithTrashed as $key => $feedback)
                            <tr class="item-{{ $feedback->id }}">
                                <td class="text-center">{{ $key + 1}}</td>
                                <td class="text-center">{{ $feedback->name }}</td>
                                <td class="text-center">{{ $feedback->code }}</td>
                                ...
                                <td class="text-center">
                                    <a href="javascript:void(0)" onclick="restore('survey/restore', '{{ $feedback->id }}' )" class="btn btn-primary" title="Khôi phục">
                                        <i class="fas fa-trash-restore"></i>
                                    </a>

                                    <a href="javascript:void(0)" onclick = "forceDelete('survey/forceDelete', '{{ $feedback->id }}' )" class="btn btn-danger" title="Xóa">
