        ...
        <div class="col-xs-12">
            <div class="box">
                ...
                <div class="box-body">
                        ...
                        <tbody>
                            ...
                            <tr class="item-{{ $question->id }}">
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="{{ route('admin.question.getListAnswer', ['id' => $question->id]) }}"
                                        class="btn btn-primary" title="Câu trả lời liên quan">
                                        <i class="fas fa-long-arrow-alt-right"></i>
                                    </a>

                                    <button type="button" class="btn btn-warning btn-detail" data-toggle="modal"
                                        data-target="#modal-default" title="Chi tiết" data-id="{{$question->id}}">
                                    ...
                                    <a href="javascript:void(0)" class="btn btn-danger"
                                        onclick="destroyModel('question', '{{ $question->id }}' )" title="Xóa">
                    ...
                    @can('forceDelete', App\FeedBack::class)
                    <div>
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            @foreach($questionsWithTrashed as $key => $question)
                            <tr class="item-{{ $question->id }}">
                                <td class="text-center">{{ $key + 1}}</td>
                                <td class="text-center">{!! Str::limit($question->content, 50) !!}</td>
                                <td class="text-center">
                                ...
                                <td class="text-center">
                                    <a href="javascript:void(0)" onclick="restore('question/restore', '{{ $question->id }}' )" class="btn btn-primary" title="Khôi phục">
                                        <i class="fas fa-trash-restore"></i>
                                    </a>

                                    <a href="javascript:void(0)" onclick = "forceDelete('question/forceDelete', '{{ $question->id }}' )" class="btn btn-danger" title="Xóa">
